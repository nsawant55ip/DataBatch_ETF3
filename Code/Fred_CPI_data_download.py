...
link_list = ["https://fred.stlouisfed.org/data/JPNCPIALLMINMEI.txt",
             "https://fred.stlouisfed.org/data/CPALCY01CAM661N.txt",
             "https://fred.stlouisfed.org/data/CPALTT01USM661S.txt",
             "https://fred.stlouisfed.org/data/CHECPIALLMINMEI.txt",
             "https://fred.stlouisfed.org/data/GBRCPIALLMINMEI.txt",
             "https://fred.stlouisfed.org/data/SWECPIALLMINMEI.txt",
             "https://fred.stlouisfed.org/data/CP0000EZ19M086NEST.txt",
             "https://fred.stlouisfed.org/data/AUSCPIALLQINMEI.txt"]

def processOptions():
    parser = argparse.ArgumentParser()
    parser.add_argument('-O','--outdir',   dest='outdir',   default="C:\\DataBatch_ETF_NewProject\\Output", help='Output Directory')
    parser.add_argument('-F','--filename', dest='filename', default="CPI_fx.csv",     help='Output filename')
...
def writeTocsv(args, table):
    ...
    with open(outputfile, 'w', newline='') as op_fh:
        ...
        header = ("DATE", "CPI_FXY", "CPI_FXC", "CPI_UUP", "CPI_FXF", "CPI_FXB", "CPI_FXS", "CPI_FXE", "CPI_FXA" )
